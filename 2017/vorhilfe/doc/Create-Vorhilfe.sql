...
CREATE TABLE schueler (
	...
	LID 	INTEGER REFERENCES lehrer (LID), --> Hier geht die Beziehung 
	email	VARCHAR (100),		-- 'ist Klassenlehrer' auf
...
CREATE TABLE kurs (
	...
	wtag wotag,
	zeit TIME,	 -- Kurszeit
	maxP INTEGER -- Maximale Teilnehmerzahl (Integritätsbedingung) 
